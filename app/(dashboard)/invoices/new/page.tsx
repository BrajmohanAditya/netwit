...
export default function NewInvoicePage() {
  ...
  useEffect(() => {
    if (selectedVehicle) {
      const retailPrice =
        parseFloat(selectedVehicle.retail_price?.toString() || "0") || 0;
            ...
            <div className="space-y-6">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        if (vehicle) {
                          const retailPrice =
                            parseFloat(
                              vehicle.retail_price?.toString() || "0",
                            ) || 0;
                          calculator.setBasePrice(retailPrice);
                        }
                      }}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <label className="text-sm font-medium mb-2 block">
                      Base Price (Vehicle Retail)
                    </label>
                    <Input
                      type="number"
                      value={calculator.basePrice}
                      onChange={(e) =>
                        calculator.setBasePrice(parseFloat(e.target.value) || 0)
                      }
                      step="0.01"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      value={packageName || ""}
                      onChange={(e) =>
                        form.setValue("package_name", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        calculator.setDiscount(parseFloat(e.target.value) || 0)
                      }
                      step="0.01"
                      placeholder="0.00"
                    />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        calculator.setTaxMode(
                          e.target.value as "gst+pst" | "hst",
                        )
                      }
                    >
